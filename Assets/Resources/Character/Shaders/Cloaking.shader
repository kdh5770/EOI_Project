Shader "Character/Cloaking"
{
		...
		SubShader
	{
		...
		CGPROGRAM
		#pragma surface surf CloakingLight noambient novertexlights nofowarded
		#pragma target 3.0

		sampler2D _GranTexture;
		sampler2D _MainTex;
		...
		void surf(Input IN, inout SurfaceOutput o)
		{
			...
			float uv_screen = IN.screenPos.xy / IN.screenPos.w;

			fixed3 mappongScreenColor = tex2D(_GranTexture, uv_screen);
